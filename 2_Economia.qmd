...
grafico <- ggplot(dados_plot, aes(x = MUNICIPIO, y = Valor, fill = Atividade)) +
  ...
  labs(title = "Valor adicionado total e segundo atividades econômicas dos Municípios do Vale do Lítio - 2021",
       x = "Município",
       y = "R$") +
...
p1 <- ggplot(dados_filtrados, aes(x = ANO, y = R_EMPRSFMI, group = Municipio, color = Municipio)) +
  ...
  labs(title = "Vínculos empregatícios formais na indústria extrativa dos municípios do Vale do Lítio - 2010-2021",
       x = "Ano",
       y = "Vínculos formais") +
  theme_minimal() +
  geom_point(size=.5)+
