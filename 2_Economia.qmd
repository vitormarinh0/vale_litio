...
<!-- ano_min <- min(tx_cres_extrativo$ano) -->
...
<!--   geom_smooth(method = "loess", se = FALSE, size=.8, linetype="dashed", alpha=0) + -->
<!--   scale_x_continuous(breaks = seq(ano_min, ano_max, by = 1)) + -->
<!--   scale_color_manual(values = c("Vale do Lítio" = "#71572e", "Minas Gerais" = "#0c343d")) + -->
<!--   theme_minimal() + -->
...
<!--   annotate(geom="curve", x=2020, xend=2021, y=-5, yend=-3.5,  -->
<!--            curvature=-0.3, arrow=arrow(length=unit(2,"mm")), size=0.2, color="#71572e")+ -->
<!--   annotate(geom="text", x=2021, y=-3, label="Crescimento de 8%", hjust=0, vjust=0, color="black", size=4) -->
