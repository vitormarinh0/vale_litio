...
# Criando o dataframe
emigrantes <- data.frame(ibge7, municipio, total, total_mg, emigrante_rgint, emigrante_out_mg, emigrante_resto_br)
...
# Criando o dataframe
df_saldo <- data.frame(ibge7, municipio, total, total_mg, saldo_migratorio_rgint, saldo_migratori_out_mg, saldo_migratori_resto_br)
